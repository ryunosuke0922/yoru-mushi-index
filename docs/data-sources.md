...
- 7 日予報では、起点日の前日から 7 日目までを 1 回の Open-Meteo request で取得する
...
画面の「取得した条件」は、対象日の 19-23 時のうちスコアが最も高い代表時刻の hourly forecast を表示します。
...
- `seasonScore`: エリアごとの季節適性。総合スコアに加点する。
- 月別の季節係数: 最終スコア全体に掛け、時期による活動量を補正する。
